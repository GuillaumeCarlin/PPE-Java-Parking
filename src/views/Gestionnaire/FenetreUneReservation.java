...
public class FenetreUneReservation extends JFrame{
    ...
    public static void main(String[]args){
        new FenetreUneReservation().setVisible(true);
    }
    ...
    public JComboBox getComboBoxPersonne() {
        return ComboBoxPersonne;
    }

    public void setComboBoxPersonne(JComboBox comboBoxPersonne) {
        ComboBoxPersonne = comboBoxPersonne;
    }
}
